            ...
            <Tooltip>
              <TooltipTrigger asChild>
                <Button
                  className="size-7 rounded-lg p-1"
                  disabled={
                    codeViewMode === "diff" || !canPrettify || isPrettified
                  }
                  onClick={onPrettify}
                  size="sm"
                  type="button"
              ...
              <TooltipContent side="top" sideOffset={4}>
                {t("preview.toolbar.prettifyCode")}
              </TooltipContent>
            </Tooltip>
            <Tooltip>
              <TooltipTrigger asChild>
